...
class ResearchDWinfo extends StatefulWidget {

  @override
  _ResearchDWinfoState createState() => _ResearchDWinfoState();
}

class _ResearchDWinfoState extends State<ResearchDWinfo> {
  @override
...
class ResearchDW extends StatefulWidget {
  @override
  _ResearchDWState createState() => _ResearchDWState();
}

class _ResearchDWState extends State<ResearchDW>
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
          ...
          child: ListView(
            children: [
              TotalAnim(title: 'Research', totalValue: 400.0,),
                            ...
                            categoryItems: [
                              ...
                              CategoryBean(widgget: Container(
                                ...
                                child: FlatButton(
                                  ...
                                  color: Colors.orange,
                                  onPressed: ()=>Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => ResearchYWinfo())),
