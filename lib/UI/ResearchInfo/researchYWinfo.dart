...
class ResearchYWinfo extends StatefulWidget {

  @override
  _ResearchYWinfoState createState() => _ResearchYWinfoState();
}

class _ResearchYWinfoState extends State<ResearchYWinfo> {
  @override
...
class ResearchYW extends StatefulWidget {
  @override
  _ResearchYWState createState() => _ResearchYWState();
}

class _ResearchYWState extends State<ResearchYW>
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
          ...
          child: ListView(
            children: [
              TotalAnim(title: 'Research', totalValue: 150.0,),
