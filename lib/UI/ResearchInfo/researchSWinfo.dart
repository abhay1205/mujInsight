...
class ResearchSWinfo extends StatefulWidget {

  @override
  _ResearchSWinfoState createState() => _ResearchSWinfoState();
}

class _ResearchSWinfoState extends State<ResearchSWinfo> {
  @override
...
class ResearchSW extends StatefulWidget {
  @override
  _ResearchSWState createState() => _ResearchSWState();
}

class _ResearchSWState extends State<ResearchSW>
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
          ...
          child: ListView(
            children: [
              TotalAnim(title: 'Research', totalValue: 800.0,),
                            ...
                            categoryItems: [
                              ...
                              CategoryBean(widgget: Container(
                                ...
                                child: FlatButton(
                                  ...
                                  color: Colors.orange,
                                  onPressed: ()=>Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => ResearchDWinfo())),
