...
import 'package:mujinsight/UI/AwardsInfo/awardsSWinfo.dart';
...
class AwardsFWinfo extends StatefulWidget {

  @override
  _AwardsFWinfoState createState() => _AwardsFWinfoState();
}

class _AwardsFWinfoState extends State<AwardsFWinfo> {
  @override
...
class AwardsFW extends StatefulWidget {
  @override
  _AwardsFWState createState() => _AwardsFWState();
}

class _AwardsFWState extends State<AwardsFW>
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
          ...
          child: ListView(
            children: [
              TotalAnim(title: 'Awards', totalValue: 1200.0,),
                            ...
                            categoryItems: [
                              ...
                              CategoryBean(widgget: Container(
                                ...
                                child: FlatButton(
                                  ...
                                  color: Colors.orange,
                                  onPressed: ()=>Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => AwardsSWinfo())),
