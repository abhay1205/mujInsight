...
import 'package:mujinsight/UI/ProgramInfo/programYWinfo.dart';
import 'package:mujinsight/UI/ResearchInfo/researchYWinfo.dart';
...
class ProgramDWinfo extends StatefulWidget {

  @override
  _ProgramDWinfoState createState() => _ProgramDWinfoState();
}

class _ProgramDWinfoState extends State<ProgramDWinfo> {
  @override
...
class ProgramDW extends StatefulWidget {
  @override
  _ProgramDWState createState() => _ProgramDWState();
}

class _ProgramDWState extends State<ProgramDW>
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
          ...
          child: ListView(
            children: [
              TotalAnim(title: 'Program', totalValue: 400.0,),
                            ...
                            categoryItems: [
                              ...
                              CategoryBean(widgget: Container(
                                ...
                                child: FlatButton(
                                  ...
                                  color: Colors.orange,
                                  onPressed: ()=>Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => ProgramYWinfo())),
