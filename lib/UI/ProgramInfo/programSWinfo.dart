...
import 'package:mujinsight/UI/ProgramInfo/programDWinfo.dart';
...
class ProgramSWinfo extends StatefulWidget {

  @override
  _ProgramSWinfoState createState() => _ProgramSWinfoState();
}

class _ProgramSWinfoState extends State<ProgramSWinfo> {
  @override
...
class ProgramSW extends StatefulWidget {
  @override
  _ProgramSWState createState() => _ProgramSWState();
}

class _ProgramSWState extends State<ProgramSW>
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
          ...
          child: ListView(
            children: [
              TotalAnim(title: 'Program', totalValue: 800.0,),
                            ...
                            categoryItems: [
                              ...
                              CategoryBean(widgget: Container(
                                ...
                                child: FlatButton(
                                  ...
                                  color: Colors.orange,
                                  onPressed: ()=>Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => ProgramDWinfo())),
