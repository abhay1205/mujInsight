...
class StudentDWinfo extends StatefulWidget {

  @override
  _StudentDWinfoState createState() => _StudentDWinfoState();
}

class _StudentDWinfoState extends State<StudentDWinfo> {
  @override
...
class StudentDW extends StatefulWidget {
  @override
  _StudentDWState createState() => _StudentDWState();
}

class _StudentDWState extends State<StudentDW>
                            ...
                            categoryItems: [
                              ...
                              CategoryBean(widgget: Container(
                                ...
                                child: FlatButton(
                                  ...
                                  color: Colors.orange,
                                  onPressed: ()=>Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => StudentYWinfo())),
