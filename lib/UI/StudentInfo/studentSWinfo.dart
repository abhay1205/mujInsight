...
class StudentSWinfo extends StatefulWidget {

  @override
  _StudentSWinfoState createState() => _StudentSWinfoState();
}

class _StudentSWinfoState extends State<StudentSWinfo> {
  @override
...
class StudentSW extends StatefulWidget {
  @override
  _StudentSWState createState() => _StudentSWState();
}

class _StudentSWState extends State<StudentSW>
                            ...
                            categoryItems: [
                              ...
                              CategoryBean(widgget: Container(
                                ...
                                child: FlatButton(
                                  ...
                                  color: Colors.orange,
                                  onPressed: ()=>Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => StudentDWinfo())),
