...
class SchoolWise extends StatefulWidget {
  @override
  _SchoolWiseState createState() => _SchoolWiseState();
}

class _SchoolWiseState extends State<SchoolWise> with TickerProviderStateMixin{
